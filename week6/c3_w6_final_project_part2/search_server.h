...
public:
    ...
    void AddQueriesStreamSingle(istream &query_input, ostream &search_results_output) const;
...
private:
    ...
    array<Count, MAX_DOC_AMOUNT> CalculateMetricsForEachDocument(const string &current_query) const;
    ...
    array<ResCountDocId, 5> ServeOneQuery(const string &current_query) const;
